...
public class FuncionarioController {
	...
	public void listarNomesFuncionariosCons() throws IOException {
		...
		Util.customizer();
		logger.log(Level.INFO,
				() -> funcionariosConsole.toString().replace("[", " ").replace("]", "").replace(",", "\n\n")
						+ "\n\nLista gerada com sucesso!\n");

	}

	public void listarFuncionarioDepartamentoCons() throws IOException {

		funcService.listaFuncionarioDepartamentoCons();
		Util.customizer();
		logger.log(Level.INFO, "\n\nLista gerada com sucesso!");
