		...
		while (true) {
			...
			if (linha != null) {
				...
				if (dados[0].equalsIgnoreCase(TipoRegistro.FUNCIONARIO.name())) {
					...
					Funcionario func = new Funcionario(Integer.parseInt(dados[1]), dados[2], LocalDate.parse(dados[3], dtf),
							dados[4], dados[5], dados[6], dados[7], dados[8], Integer.parseInt(dados[9]));
...
/*	public static void escritor(String path) throws IOException {
		...
		BufferedWriter buffWrite = new BufferedWriter(new FileWriter(PATH_BASICO + nome + path + EXTENSAO, true));
		String linha = "";
